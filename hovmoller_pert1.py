...
def hovmoller1(psi_c, psi, lon, lat, estado_basico, perturbacion,nombre):
    ...
    plt.figure()
    plt.contourf(lon[0:360],dias, anomalia_10dias[:,43,0:360]/100000, cmap = 'viridis') 
    cb = plt.colorbar()
    cb.set_label('$x10^{5}$', labelpad = -38, y=1.1, rotation=0,fontsize=11)
    plt.contour(lon[0:360],dias, anomalia_10dias[:,43,0:360]/100000, levels = 0, colors = "w" )
