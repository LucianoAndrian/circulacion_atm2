...
def hovmoller2(psi_c, psi, lon, lat, estado_basico, perturbacion,nombre):
    ...
    plt.figure()
    plt.contourf(lon[58:360],dias, anomalia_10dias[:,31,58:360]/100000, cmap = 'viridis') 
    plt.colorbar()
    plt.contour(lon[58:360],dias, anomalia_10dias[:,31,58:360]/100000, levels = 0, colors = "w" )
