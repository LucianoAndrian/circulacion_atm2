...
def mapa3(cmin1,cmax1,cmin2,cmax2,ncont,lat,lon,L,VAR1,VAR2,cmap,nombre_titulo,nombre_archivo):
    ...
    cb2.set_label('$x10^{5}$', labelpad = -30, y=1.08, rotation=0,fontsize=5.8)
    ...
    #Titulo
    #plt.title(nombre_titulo, fontsize=6, y=2.2, loc="center")
